...
- Pylint owns broader design pressure: too many arguments, locals, branches, returns, statements, nested blocks, public methods, instance attributes, duplicate code, and cyclic imports.
...
| Function and class size pressure, `CC-033..CC-059`, `CC-137..CC-142`, `CC-206` | Pylint design messages |
...
The thresholds are intentionally moderate. They should be relaxed for framework entrypoints, generated code, migrations, tests, and compatibility layers through project-local overrides.
